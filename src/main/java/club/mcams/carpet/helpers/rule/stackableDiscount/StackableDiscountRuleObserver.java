...
public class StackableDiscountRuleObserver {
    public static void initStackableDiscountObserver() {
        //#if MC>=12002
        //$$ if (AmsServerSettings.stackableDiscounts) {
        //$$     activateStackableDiscount();
        //$$ }
        //$$ else {
        //$$     deactivateStackableDiscount();
        //$$ }
        //$$ CarpetServer.settingsManager.registerRuleObserver(
        //$$     (source, rule, s) -> {
        //$$         if (rule.name().equals("stackableDiscount")) {
        //$$             if (AmsServerSettings.stackableDiscounts) {
        //$$                 activateStackableDiscount();
        //$$             }
        //$$             else {
    ...
    private static void activateStackableDiscount() {
    ...
    private static void deactivateStackableDiscount() {
