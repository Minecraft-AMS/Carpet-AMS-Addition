...
package carpetamsaddition.mixin.rule.maxChainUpdateDepth;
...
public abstract class CollectingNeighborUpdaterMixin {
    ...
    private int modifyMaxChainDepth(int original) {
        return CarpetAMSAdditionSettings.maxChainUpdateDepth == -1 ? original : CarpetAMSAdditionSettings.maxChainUpdateDepth;
    }
}
