...
package carpetamsaddition.mixin.rule.pointedDripstoneCollisionBoxDisabled;
...
public abstract class BlockStateBaseMixin {
    ...
    private VoxelShape getCollisionShape(VoxelShape original) {
        if (CarpetAMSAdditionSettings.pointedDripstoneCollisionBoxDisabled && this.getBlock() == Blocks.POINTED_DRIPSTONE) {
            return Shapes.empty();
        } else {
            return original;
        }
