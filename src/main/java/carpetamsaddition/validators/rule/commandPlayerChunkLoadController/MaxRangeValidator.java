...
package carpetamsaddition.validators.rule.commandPlayerChunkLoadController;
...
public class MaxRangeValidator extends Validator<Integer> {
    private static final Translator tr = new Translator("validator.blockChunkLoaderRangeController");
