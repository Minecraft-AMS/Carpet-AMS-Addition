...
`note_block`: 开启后，当上边沿红石信号激活音符盒时，为该音符盒所在区块添加类型为"note_block"，加载等级为30加载票，持续时间为300gt（15s）。

`bell_block`: 开启后，当上边沿红石信号激活钟时，为钟方块所在区块添加类型为"bell_block"，加载等级为30加载票，持续时间为300gt（15s）。
